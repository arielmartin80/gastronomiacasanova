			...
			<div class="mx-auto col-md-10 p-4">
				...
				<div class="row">
					<div class="col-12 text-light">
						<h1>Liquidaciones Repartidor</h1><br>
					</div>
				</div>
					...
					<div class="container justify-content-center"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar3">
						...
						<div class="collapse navbar-collapse text-center justify-content-center" id="navbar3">
							<ul class="navbar-nav">
								...
								<li class="nav-item nav-link mx-2 border border-warning"> <a class="nav-link navbar-brand mr-0 text-warning" href="/pedidos/pendientes">
										<b> PEDIDOS</b></a> 
								</li>

				                <li class="nav-item nav-link active mx-2 border border-warning"> <a class="nav-link navbar-brand mr-0 text-light" href="/liquidacion/liquidacionesRepartidor">
				                  		<b> LIQUIDACIONES</b></a>
				                </li>
